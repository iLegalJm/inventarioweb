                ...
                <div class="container px-5 py-24 mx-auto">
                    <div class=" lg:w-4/5 mx-auto flex flex-wrap">
                        <div class="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
                            <h2 class="text-sm title-font text-gray-500 tracking-widest">{{ $producto->codigo }}</h2>
                            <h1 class="text-gray-900 text-3xl title-font font-medium mb-4">{{ $producto->nombre }}</h1>
                            <div class="flex mb-4">
                                <a
                            ...
                            <p class="leading-relaxed mb-4">{{ $producto->descripcion }}</p>
                            <div class="flex border-t border-gray-200 py-2">
                                <span class="text-gray-500">Marca</span>
                                <span class="ml-auto text-gray-900">{{ $producto->marca }}</span>
                            </div>
                            <div class="flex border-t border-gray-200 py-2">
                                <span class="text-gray-500">Modelo</span>
                                <span class="ml-auto text-gray-900">{{ $producto->modelo }}</span>
                            </div>
                            <div class="flex border-t border-gray-200 py-2">
                                <span class="text-gray-500">Tamaño</span>
                                <span class="ml-auto text-gray-900">{{ $producto->tamaño }}</span>
                            </div>
                            <div class="flex border-t border-b mb-6 border-gray-200 py-2">
                                <span class="text-gray-500">Cantidad</span>
                                <span class="ml-auto text-gray-900">{{ $producto->stock }}</span>
                            </div>
                            <div class="flex">
                                <span
