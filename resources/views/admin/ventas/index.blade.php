            ...
            <table id="ingresos" class="table table-hover table-striped table-sm cursor-default"">
                ...
                <tbody class="">
                    @foreach ($ordenventas as $ordenventa)
                        <tr>
                            <td>{{ $ordenventa->id }}</td>
                            <td>{{ $ordenventa->codigo }}</td>
                            <td>{{ $ordenventa->fecha }}</td>
                            <td>{{ $ordenventa->idtipopago }}</td>
                            @if ($ordenventa->idestado == 1)
                                <td>Almacén</td>
                            @else
                                <td>Despachado</td>
                            @endif
                            <td style="">
                                <a href="{{ route('admin.ordenventas.edit', $ordenventa) }}"
                                    class="btn btn-sm btn-primary">Editar</a>
                                {{-- <button id="btnmodal" type="button" class="btn btn-warning btn-sm" data-toggle="modal"
                                    data-target="#exampleModal" data-datos="{{ $ordenventa->ordenpedido }}"><i
