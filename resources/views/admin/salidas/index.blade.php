                ...
                <tbody class="">
                    @foreach ($salidas as $salida)
                        <tr>
                            <td>{{ $salida->id }}</td>
                            <td>{{ $salida->codigo }}</td>
                            <td>{{ $salida->fechaorden }}</td>
                            <td>{{ $salida->idestado }}</td>
                            <td style="">
                                <a href="{{ route('admin.ingresos.edit', $salida) }}" class="btn btn-primary btn-sm"><i
                                        class="fa fa-solid fa-edit"></i></a>
                                <button id="btnmodal" type="button" class="btn btn-warning btn-sm" data-toggle="modal"
                                    data-target="#exampleModal" data-datos="{{ $salida->detalleingresosalida }}"
                                    @foreach ($salida->detalleingresosalida as $key => $detalle) data-produ{{ $key }}="{{ $detalle->producto }}" @endforeach><i class="fa fa-solid fa-eye"></i></button>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
            ...
            buttons: [{
                ...
                },
                {
                    ...
                    action: function(e, dt, button, config) {
                        window.location = 'salidas/create';
                    }
                }
            ],
            lengthMenu: [10, 25, 50],
