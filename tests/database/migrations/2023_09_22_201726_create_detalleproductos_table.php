...
class CreateDetalleproductosTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('detalleproductos', function (Blueprint $table) {
            ...
            $table->foreign('almacenes_id', 'fk_detalleproductos_almacenes1')->references('id')->on('almacenes');
            $table->foreign('productos_id', 'fk_detalleproductos_productos1')->references('id')->on('productos');
        });
    }
